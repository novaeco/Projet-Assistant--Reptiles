...
#ifdef CONFIG_BOARD_LCD_POL_PCLK_ACTIVE_NEG
#define BOARD_LCD_PCLK_ACTIVE_NEG CONFIG_BOARD_LCD_POL_PCLK_ACTIVE_NEG
#else
#define BOARD_LCD_PCLK_ACTIVE_NEG 1
#endif

#ifdef CONFIG_BOARD_LCD_POL_HSYNC_IDLE_LOW
#define BOARD_LCD_HSYNC_IDLE_LOW CONFIG_BOARD_LCD_POL_HSYNC_IDLE_LOW
#else
#define BOARD_LCD_HSYNC_IDLE_LOW 0
#endif

#ifdef CONFIG_BOARD_LCD_POL_VSYNC_IDLE_LOW
#define BOARD_LCD_VSYNC_IDLE_LOW CONFIG_BOARD_LCD_POL_VSYNC_IDLE_LOW
#else
#define BOARD_LCD_VSYNC_IDLE_LOW 0
#endif

#ifdef CONFIG_BOARD_LCD_POL_DE_IDLE_HIGH
#define BOARD_LCD_DE_IDLE_HIGH CONFIG_BOARD_LCD_POL_DE_IDLE_HIGH
#else
...
#ifdef CONFIG_BOARD_LCD_BOUNCE_LINES
#define BOARD_LCD_BOUNCE_LINES CONFIG_BOARD_LCD_BOUNCE_LINES
#else
#define BOARD_LCD_BOUNCE_LINES 0
#endif
...
// Backlight
// =============================================================================
#define BOARD_LCD_BK_LIGHT_GPIO      GPIO_NUM_15
